...
**Vet Clinic** is a program that allows user to get familiar with database (Postgresql) usage. It contains basic query syntaxes that will get you catch database usage.
